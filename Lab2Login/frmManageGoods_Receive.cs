...
namespace Lab2Login
{
    public partial class frmManageGoods_Receive : Form
    {
        int AorderID;
        int GID;
        int AGID;
        String strConn = ConfigurationManager.ConnectionStrings["MyConn"].ConnectionString;
        public frmManageGoods_Receive(int AorderIDD)
        {
        ...
        public void reload()
        {
            ...
            //conn.ConnectionString = @"Data Source=(local)\SQLEXPRESS; Initial Catalog=finalCNPM;Integrated Security=True";
            conn.Open();
            String sSQL = "SELECT * FROM Goods_Receive WHERE AorderID=@AorderID";
            SqlCommand cmd = new SqlCommand(sSQL, conn);
            SqlDataAdapter da = new SqlDataAdapter(cmd);
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            //conn.ConnectionString = @"Data Source=(local)\SQLEXPRESS; Initial Catalog=finalCNPM;Integrated Security=True";
            conn.Open();
            String sSQL = "INSERT INTO Goods_Receive (AorderID, GID, Quantity, GName) VALUES(@AorderID, @GID, @Quantity, @GName)";
            ...
            MessageBox.Show("Lưu thông tin hàng hóa thành công!");
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            //conn.ConnectionString = @"Data Source=(local)\SQLEXPRESS; Initial Catalog=finalCNPM;Integrated Security=True";
            conn.Open();
            String sSQL = "DELETE FROM Goods_Receive WHERE AorderGoodsID=@AGID";
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            //conn.ConnectionString = @"Data Source=(local)\SQLEXPRESS; Initial Catalog=finalCNPM;Integrated Security=True";
            conn.Open();
            String sSQL = "UPDATE Goods_Receive SET GID=@GID, Quantity=@Quantity, GName=@GName WHERE AorderGoodsID=@AGID";
            SqlCommand cmd = new SqlCommand(sSQL, conn);
            cmd.Parameters.Add(new SqlParameter("@GID", GID));
            cmd.Parameters.Add(new SqlParameter("@Quantity", int.Parse(txtQuantity.Text)));
            ...
            MessageBox.Show("Cập nhật thông tin hàng hóa thành công!");
            dataGridView1.Refresh();
            reload();
        }
